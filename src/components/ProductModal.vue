            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-2">
                  ...
                  <span v-for="(picture,id) in localProduct.imagesUrl" v-bind:key="id">
                    <label :for="'imagesUrl'+id" class="form-label mx-4">輸入圖片網址</label>
                    <input :id="'imagesUrl'+id" type="text" class="form-control" placeholder="請輸入圖片連結" v-model="localProduct.imagesUrl[id]">
